...
<script>
    export default {
        ...
        created() {
            const _this = this
            this.axios.get('getShareAll').then(function (resp) {
                _this.items = resp.data
                console.log( resp.data)
            })
            this.axios.get('getShareCmdAll').then(function (resp) {
        ...
        methods:{
            getGoodsList:function () {
                this.axios.get(`buyRemind/getShareAll/six/${this.currentPage-1}/20`).then(function (resp) {
                ...
                const _this = this
                this.axios.get('getShareAll/cmd='+cmd).then(function (resp) {
                    _this.items = resp.data
                    console.log( resp.data)
                })
            },onSubmit(event) {
